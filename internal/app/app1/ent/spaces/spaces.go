...
const (
	// Label holds the string label denoting the spaces type in the database.
	Label = "spaces"
	...
	// Table holds the table name of the spaces in the database.
	Table = "spaces"
