...
func ID(id int) predicate.Bucket {
	return predicate.Bucket(
		func(s *sql.Selector) {
...
func IDEQ(id int) predicate.Bucket {
...
func IDNEQ(id int) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpoint(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointEQ(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCdnEndpoint), v))
	},
	)
...
func CdnEndpointNEQ(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointIn(vs ...string) predicate.Bucket {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CdnEndpointNotIn(vs ...string) predicate.Bucket {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CdnEndpointGT(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointGTE(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointLT(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointLTE(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointContains(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointHasPrefix(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointHasSuffix(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointIsNil() predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointNotNil() predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointEqualFold(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
...
func CdnEndpointContainsFold(v string) predicate.Bucket {
	return predicate.Bucket(func(s *sql.Selector) {
