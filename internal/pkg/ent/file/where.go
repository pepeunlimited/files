...
func IsDraft(v bool) predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func UserID(v int64) predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func IsDraftEQ(v bool) predicate.File {
	return predicate.File(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldIsDraft), v))
	},
	)
...
func IsDraftNEQ(v bool) predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func UserIDEQ(v int64) predicate.File {
	return predicate.File(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUserID), v))
	},
	)
...
func UserIDNEQ(v int64) predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func UserIDIn(vs ...int64) predicate.File {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UserIDNotIn(vs ...int64) predicate.File {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UserIDGT(v int64) predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func UserIDGTE(v int64) predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func UserIDLT(v int64) predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func UserIDLTE(v int64) predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func HasBuckets() predicate.File {
	return predicate.File(func(s *sql.Selector) {
...
func HasBucketsWith(preds ...predicate.Bucket) predicate.File {
	return predicate.File(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
